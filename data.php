...
// Khai báo hằng số tên cửa hàng
define('STORE_NAME', 'MiniShop');
...
// Tạo mảng đối tượng Category
$categoryObjects = [];
foreach ($categories as $cat) {
    $categoryObjects[] = new Category($cat['id'], $cat['name']);
}

// Tạo mảng đối tượng Product
$productObjects = [];
foreach ($products as $prod) {
    $productObjects[] = new Product($prod['sku'], $prod['name'], $prod['category_id'], $prod['price'], $prod['qty']);
}
?>
